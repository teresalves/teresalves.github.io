...
### Resiliency vs Consistency: Racing multiple Data Sources
###### 20/10/2025

I was a guest speaker for LisboaJs' first anniversary! 🎉
In this, my first recorded technical talk, I got to speak about the product that we are building at Cloudflare - Workers KV - which is a distributed database to be used in your Cloudflare Workers application.

More on Cloudflare Workers: https://workers.cloudflare.com/

More on Workers KV: https://developers.cloudflare.com/kv/

Note that we are building technical tools for technical people, so the talk itself might be a bit too technical if you have no prior knowledge of Workers, distributed systems or Javascript. If you know a minimum of any of these things, you'll be able to follow this talk.

Recording here: https://www.youtube.com/watch?v=wisMpAhU8bY
